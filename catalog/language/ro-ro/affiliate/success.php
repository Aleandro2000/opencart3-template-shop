<?php
// Heading
$_['heading_title'] = 'Contul dvs. de afiliat a fost creat!';

// Text
$_['text_message']  = '<p>Felicitări! Noul dvs. cont a fost creat cu succes!</p> <p>You are now a member of %s affiliates.</p> <p>If you have ANY questions about the operation of this affiliate system, please e-mail the store owner.</p> <p>A confirmation has been sent to the provided e-mail address. If you have not received it within the hour, please <a href="%s">contact us</a>.</p>';
